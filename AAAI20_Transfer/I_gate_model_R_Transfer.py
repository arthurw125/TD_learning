# Input Gate Only w/ abstraction, Train on Red task and transfer to GP
# coding: utf-8
...
LTM_obj2, agent2, i_gate2, o_gate2, WM2 = Transfer_Task(WM_Objs,[5,5],100000,1000,100000,'igateR')
# In[ ]:
