# Train on RedPurple task and transfer to P
# coding: utf-8
...
def IO_gate_model(state_size,nepisodes,stat_window,ep_0):
    ...
    nsteps = 100
    #goal = [ [0,0],[0,ncols-1] ]
    goal = [ [0,0],[0,ncols//2] ] # RedPurple Task Goal
    #goal = [ [2,0],[2,ncols-1] ]
...
LTM_obj2, agent2, i_gate2, o_gate2, WM2 = Transfer_Task(WM_Objs,[5,5],100000,1000,100000,'RP')
# In[ ]:
