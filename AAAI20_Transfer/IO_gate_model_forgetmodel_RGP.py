...
def IO_gate_model(state_size,nepisodes,stat_window,ep_0):
    ...
    fname = 'step_diff_RGP_testing.dat'
    fname2 = 'step_diff_red_RGP_testing.dat'
    fname3 = 'step_diff_green_RGP_testing.dat'
    fname4 = 'step_diff_purple_RGP_testing.dat'
    fname5 = 'memory_states_RGP_testing.dat'
    fname6 = 'step_diff_RGP_training.dat'
...
LTM_obj2, agent2, i_gate2, o_gate2, WM2 = IO_gate_model([5,5],100000,1000,100000)
