# Input Gate Only w/ abstraction, Train on task and transfer 
# coding: utf-8
...
def Transfer_Task(WM_Objs,state_size,nepisodes,stat_window,ep_0,task):
    ...
    while episode < nepisodes+1:
        ...
        if color != nothing:    
            ...
            #print(step_diff)
            all_diff_array.append(step_diff)
...
#LTM_obj, agent, i_gate, o_gate, WM = I_gate_model([5,5],10000,1000,10000)
#WM_Objs = [LTM_obj, agent, i_gate, o_gate, WM]

# Transfer Task RedGreen
#LTM_obj2, agent2, i_gate2, o_gate2, WM2 = Transfer_Task(WM_Objs,[5,5],10000,1000,10000,'RG')
# In[ ]:
