# Input Gate Only w/ abstraction, Train on RedGreen task and transfer to P
# coding: utf-8
...
import time
from I_gate_model_Transfer_functions import Transfer_Task
...
def I_gate_model(state_size,nepisodes,stat_window,ep_0):
    ...
    fname = 'igate_step_diff_RGP_testing.dat'
    fname2 = 'igate_step_diff_red_RGP_testing.dat'
    fname3 = 'igate_step_diff_green_RGP_testing.dat'
    fname4 = 'igate_step_diff_purple_RGP_testing.dat'
    #fname5 = 'memory_states_RGP_testing.dat'
    fname6 = 'igate_step_diff_RGP_training.dat'
...
LTM_obj, agent, i_gate, o_gate, WM = I_gate_model([5,5],100000,1000,100000)
