# Input Gate Only w/ abstraction, Train on Purple task and transfer to RG
# coding: utf-8
...
LTM_obj2, agent2, i_gate2, o_gate2, WM2 = Transfer_Task(WM_Objs,[5,5],100000,1000,100000,'igateP')
# In[ ]:
